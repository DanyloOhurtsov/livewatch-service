...
import { LiveBadge, UserAvatar } from "./components";
    ...
    if (!src) {
        ...
        content = (
            <Image
                ...
                fill
                alt="Thumbnail"
                className=" object-cover transition-transform group-hover:translate-x-2 group-hover:-translate-y-2 rounded-md flex items-center justify-center"
            />
        );
    }
    return (
